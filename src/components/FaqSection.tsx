...
export const FaqSection: React.FC = () => {
  ...
  const faqs = [
    {
      question: 'What types of commercial facilities does Mirola service across New Jersey?',
      answer: 'We provide specialized janitorial, terminal sanitation, and floor care solutions for corporate office buildings, medical and outpatient clinics, industrial warehouses, private schools, and commercial showrooms throughout all New Jersey counties.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes. Our New Jersey service dispatch operates 24/7. When unexpected plumbing issues, spills, or urgent sanitization needs arise, we deploy rapid-response teams within 60 to 90 minutes.'
    },
    {
