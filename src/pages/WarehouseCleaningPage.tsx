...
export const WarehouseCleaningPage: React.FC<WarehouseCleaningPageProps> = ({
  ...
  return (
    <ServicePageLayout
      ...
      subtitle="Heavy-duty concrete floor scrubbing, high-bay structural dusting, packing debris management, and loading dock sanitation engineered for high-volume logistics hubs."
